...
if  (arg_accion == 'nuevo') {
    async function ingresar(nombre,rut,curso,nivel) {
        pool.connect( async (error_conexion,client,release) => {
            ...
            const SQLQuery = {
                name:'ingresar-usuario', //Prepared Statement
...
if (arg_accion == 'rut') {
    async function consulta_rut(rut) {
        pool.connect( async (error_conexion,client,release) => {
            if ( error_conexion) return console.error(error_conexion.code);
            const SQLQuery = {
                name:'consulta-por-rut', //Prepared Statement
...
if (arg_accion == 'consulta') {
    async function consultar_todos(){
        pool.connect( async (error_conexion,client,release) => {
            if ( error_conexion) return console.error(error_conexion.code);
            const SQLQuery = {
                name:'consultar-usuarios', //Prepared Statement
...
if (arg_accion == 'editar') {
    async function editar(nombre,rut,curso,nivel){
        pool.connect( async (error_conexion,client,release) => {
            if ( error_conexion) return console.error(error_conexion.code);
            const SQLQuery = {
                name:'editar-usuario', //Prepared Statement
...
if (arg_accion == 'eliminar') {
    async function eliminar(rut) {
        pool.connect( async (error_conexion,client,release) => {
            if ( error_conexion) return console.error(error_conexion.code);
            const SQLQuery = {
                name:'eliminar-usuario', //Prepared Statement
